  ...
  _createClass(ImageGallery, [{
    ...
    value: function _getTranslateXForTwoSlide(index) {
      ...
      var _state = this.state,
          ...
          offsetPercentage = _state.offsetPercentage,
    ...
    key: '_isVideo',
    value: function _isVideo(item) {
      return !!item.embedUrl;
    }
  }, {
    key: '_renderVideo',
    value: function _renderVideo(item) {
      return _react2.default.createElement(
        'div',
        { className: 'image-gallery-image' },
        this.state.video == item.embedUrl ? _react2.default.createElement(
          'div',
          ...
          'a',
          { onClick: this.showVideo.bind(this, item.embedUrl) },
    ...
    value: function render() {
      ...
      var _state3 = this.state,
          ...
          modalFullscreen = _state3.modalFullscreen,
      ...
      this.props.items.map(function (item, index) {
        ...
        var renderItem = _this7._isVideo(item) ? _this7._renderVideo.bind(_this7) : item.renderItem || _this7.props.renderItem || _this7._renderItem.bind(_this7);
